  ...
  return (
    <div className="h-screen overflow-y-auto">
      <div className="max-w-xl mx-auto px-6 py-8">
        ...
        {/* Whisper – Jarvis Spracherkennung (lokal) */}
        <section className="mb-6 p-4 rounded-xl bg-cyan-500/5 border border-cyan-500/20 flex items-start gap-3">
          <Mic size={16} className="text-cyan-400 mt-0.5 shrink-0" />
          <div>
            <p className="text-sm font-medium text-cyan-400">Whisper STT – kostenlos & lokal</p>
            <p className="text-xs text-white/40 mt-0.5">
              Jarvis nutzt OpenAI Whisper (Open Source, MIT-Lizenz) direkt auf deinem Gerät.
              Beim ersten Start wird das Modell einmalig heruntergeladen (~75 MB) und danach lokal gecacht.
              Kein API-Key nötig.
            </p>
          </div>
        </section>
